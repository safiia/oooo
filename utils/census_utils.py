...
#	data_dir = './data/census/'
	traindata = sio.loadmat('./data/census/CensusTrain.mat')['traindata']
	traindata =['traindata']
	testdata = sio.loadmat('./data/census/CensusTest.mat')['testdata']
	#traindata = sio.loadmat(data_dir+'adult.mat')['traindata']
	#testdata = sio.loadmat(data_dir+'adulttest.mat')['testdata']
